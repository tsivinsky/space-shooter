...
func (player *Player) Draw(screen *ebiten.Image) {
	...
	baseOpts.GeoM.Scale(player.scale, player.scale)
	...
	engineOpts.GeoM.Scale(player.scale, player.scale)
	...
	effectOpts.GeoM.Scale(player.scale, player.scale)
	...
	weaponOpts.GeoM.Scale(player.scale, player.scale)
